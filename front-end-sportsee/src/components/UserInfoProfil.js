/** 
   * Component that displays the different graphs of the application Barchart, LineChart, RadarChart, RadialCharts depending on the user id
   * @param {} 
   * @return {}
...
import { RadialBarChartGraph } from "./RadialBarChartGraph";
import {routeCallApiOrMocksDAta} from "../call Api/routeCallApiOrMocksDAta";
import { useNavigate } from "react-router-dom";




export function UserInfoProfil() {
  
  let {Id} = useParams();
  let navigate = useNavigate();

  const [usersInfosDetails, setUserInfosName] = useState([]);
 


 useEffect(()=>{

    routeCallApiOrMocksDAta(Id).then((result)=>{
     
      setUserInfosName(result);
  ...
  const errorid = usersInfosDetails.filter((user)=>{
    ...
    if(user == undefined){
     ...
     if(errorid.length ===0 || errorid.length === 3){


        return   navigate("/user/ErrorID");


     } else {


      const userInfo =usersInfosDetails.filter((user)=>{
    ...
    const userInfoAVERAGE =usersInfosDetails.filter((user)=>{

      if(user.arrayNameGet == "AVERAGE" ){
  ...
  const userInfoActivity =usersInfosDetails.filter((user)=>{     

    if(user.arrayNameGet == "ACTIVITY" ){
      ...
      return(
          ...
          <h1>Bonjour {userInfo.map((userFirsName, id)=>(

            <span className="usernameprofil" key={id}>{userFirsName.userInfos.firstName} </span>
          ...
          <div className="gridCart">
              ...
              <div className="cartStatBar">
                ...
                {userInfoActivity.map((user)=>(


                   <BarchartGraph key={user.userId} userInfosActivityData={user}/>
                ...
                <div className="cartStatPerformance">

                <div className="statPerformanceSessions">

                  {userInfoAVERAGE.map((user)=>(


                    <LineChartGraph key={user.userId} userInfoSessionsData={user} />
                    ...
                    <RadarChartGraph userInfoPerformances ={usersInfosDetails} />

                    <RadialBarChartGraph userInfoScore={userInfo}/>                         
              ...
              <div className="cartFlex">
                  ...
                  <div className="cartFoodnutrent">
                      ...
                      <div className="keyData">
                        ...
                        {userInfo.map((user,id)=>(
                           ...
                           <span className="foodnutrentData" key={id}>{user.keyData.calorieCount}kCal</span>

                        ))}
                         

                        <span className="foodnutrentName">Calories</span>                  
                  ...
                  <div className="cartFoodnutrent">
                    ...
                    <div className="backgroundIcon" id="backgroundIconProteines">
                    ...
                    <path d="M18.2353 2.47058C17.8824 2.11764 17.4118 1.88234 17.0588 1.88234C16.9412 1.41176 16.8235 1.05881 16.4706 0.705873C15.6471 -0.117656 14.2353 -0.117656 13.4118 0.705873C12.7059 1.41176 12.5882 2.58823 13.1765 3.41176L10.5882 5.88234L9.29412 4.58823L6.70588 7.17646C6.47059 7.05881 6.11765 7.05881 5.88235 7.05881C2.58824 7.05881 0 9.64705 0 12.9412C0 16.2353 2.58824 18.8235 5.88235 18.8235C9.17647 18.8235 11.7647 16.2353 11.7647 12.9412C11.7647 12.7059 11.7647 12.3529 11.6471 12.1176L14.2353 9.5294L12.9412 8.23528L15.4118 5.7647C16.2353 6.35293 17.4118 6.23529 18.1176 5.5294C19.0588 4.70587 19.0588 3.29411 18.2353 2.47058Z" fill="#4AB8FF"/>
                      ...
                      <div className="keyData">
                        ...
                        {userInfo.map((user,id)=>(
                           ...
                           <span className="foodnutrentData" key={id}>{user.keyData.proteinCount}g</span>


                        ))}
                        

                        <span className="foodnutrentName">Proteines</span>
                  ...
                  <div className="cartFoodnutrent">
                       ...
                       <div className="backgroundIcon" id="backgroundIconGlucides">
                      ...
                      <path d="M1.84285 15.1C2.27535 16.0575 2.4816 16.485 3.0391 17.3313C3.81535 18.5125 4.9091 19.985 6.26535 19.9975C7.47035 20.0088 7.78035 19.2138 9.41535 19.2225C11.0503 19.2313 11.3928 20.0113 12.5978 20C13.9541 19.9875 14.9903 18.6588 15.7678 17.4763C17.9378 14.1713 18.1653 10.2938 16.8266 8.2325C15.8753 6.76625 14.3741 5.91 12.9616 5.91C11.5241 5.91 10.6216 6.6975 9.43285 6.6975C8.28035 6.6975 7.57785 5.90875 5.91535 5.90875C4.6591 5.90875 3.32785 6.5925 2.38035 7.77375C5.4866 9.4775 4.9816 13.9138 1.84285 15.1V15.1Z" fill="#FDCC0C"/>
                      ...
                      <div className="keyData">
                           ...
                           <span className="foodnutrentData" key={id}>{user.keyData.carbohydrateCount}g</span>


                        ))}
                        

                        <span className="foodnutrentName">Glucides</span>
                    ...
                    <path fillrule="evenodd" cliprule="evenodd" d="M11.25 0H8.75C4.625 0 1.25 3.375 1.25 7.5H18.75C18.75 3.375 15.375 0 11.25 0ZM7.5 5C6.75 5 6.25 4.5 6.25 3.75C6.25 3 6.75 2.5 7.5 2.5C8.25 2.5 8.75 3 8.75 3.75C8.75 4.5 8.25 5 7.5 5ZM12.5 5C12.5 5.75 13 6.25 13.75 6.25C14.5 6.25 15 5.75 15 5C15 4.25 14.5 3.75 13.75 3.75C13 3.75 12.5 4.25 12.5 5Z" fill="#FD5181"/>
                      ...
                      <div className="keyData">
                         ...
                         {userInfo.map((user,id)=>(
                           ...
                           <span className="foodnutrentData" key={id}>{user.keyData.lipidCount}g</span>


                        ))}
                        

                        <span className="foodnutrentName">Lipides</span>
